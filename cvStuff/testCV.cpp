...
{
    string fpsString = cv::format("FPS : %.2f", (float)fps);
    if (frame >= 0)
        cout << "Frame " << frame << ", ";
...
int main(int argc, char** argv)
{
    ...
    Ptr<FaceDetectorYN> detector = FaceDetectorYN::create("./face_detection_yunet_2023mar.onnx", "", Size(320, 320), scoreThreshold, nmsThreshold, topK);
